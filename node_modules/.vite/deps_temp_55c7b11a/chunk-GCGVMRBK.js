...
var ICONS = {
  add: async () => (await import("./add-MPSMHTGR.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-WG5GRPDB.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-EPRJVQG4.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-YSMZBXJG.js")).appStoreSvg,
  apple: async () => (await import("./apple-FZIEB3PF.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-I7IGVL7Z.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-7WUTFPVJ.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-MDRNQZJD.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-CA6PSJCN.js")).arrowTopSvg,
  bank: async () => (await import("./bank-CBV6ZYT4.js")).bankSvg,
  browser: async () => (await import("./browser-AH3LMC76.js")).browserSvg,
  card: async () => (await import("./card-S2L2JDDM.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7REZCBTK.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-K6JBK7MX.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-CSTNHIHZ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-AW3MPDGT.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-O3X64E45.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-PDRUZVYS.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-NEC3QKBX.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-A3XW6NDS.js")).clockSvg,
  close: async () => (await import("./close-3EJKQCG5.js")).closeSvg,
  compass: async () => (await import("./compass-QKFDZ4G6.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-67RR4ZR5.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-YF3CDCK7.js")).copySvg,
  cursor: async () => (await import("./cursor-D6S67RFA.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-EUCJCL3C.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-RMBOOVP7.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-SRZOB5DZ.js")).disconnectSvg,
  discord: async () => (await import("./discord-T25KKKJR.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-LICOQYGL.js")).etherscanSvg,
  extension: async () => (await import("./extension-QEXMS7K6.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-6OEX56HJ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-2YEVSASX.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-HU3DL3AP.js")).farcasterSvg,
  filters: async () => (await import("./filters-FYYN7OKS.js")).filtersSvg,
  github: async () => (await import("./github-FQT3DVQW.js")).githubSvg,
  google: async () => (await import("./google-QEVO33IO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-6YCBEUFG.js")).helpCircleSvg,
  image: async () => (await import("./image-LUAXXHNS.js")).imageSvg,
  id: async () => (await import("./id-MSACRJAF.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-RCOADI6U.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-HRIJEMDD.js")).lightbulbSvg,
  mail: async () => (await import("./mail-NYD2MWXL.js")).mailSvg,
  mobile: async () => (await import("./mobile-FAYKLIHM.js")).mobileSvg,
  more: async () => (await import("./more-3XJXM76H.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-6MYQ6M5M.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-OCE7YW7Y.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-UWCYPQEY.js")).offSvg,
  playStore: async () => (await import("./play-store-SANUFNKP.js")).playStoreSvg,
  plus: async () => (await import("./plus-6T3YNETX.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-DWIAO6MQ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-RSIKCDIF.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-RDVARYG6.js")).refreshSvg,
  search: async () => (await import("./search-UEDXMGUS.js")).searchSvg,
  send: async () => (await import("./send-S6Q2VCQC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-KRZQEB4W.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-SF3NZNIP.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-KEPKZEOO.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-UFJKEC7Q.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-ODEHJDZO.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-OG3CA2ZO.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-6QHAYM4E.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-YTNNXNH3.js")).twitchSvg,
  twitter: async () => (await import("./x-EJGJ7FVL.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-5LTIF6BB.js")).twitterIconSvg,
  verify: async () => (await import("./verify-AWX4BGSJ.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-JHWZWNQI.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-BSYM2OBS.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-6E4EDVLE.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-6E4EDVLE.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-6E4EDVLE.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-L6JXYWKO.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-OJBUCJGJ.js")).warningCircleSvg,
  x: async () => (await import("./x-EJGJ7FVL.js")).xSvg,
  info: async () => (await import("./info-BSP3BHTX.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-HSBVISRV.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-YY2RYPAD.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GCGVMRBK.js.map
