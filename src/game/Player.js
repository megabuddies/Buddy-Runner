export default class Player {
  ...
  constructor(ctx, width, height, minJumpHeight, maxJumpHeight, scaleRatio, onMovementCallback = null) {
    ...
    this.standingStillImage.onerror = () => {
      if (import.meta.env.DEV) console.error('Failed to load buddy_standing_still.png');
    };
    this.image = this.standingStillImage;

    this.jumpingImage = new Image();
    this.jumpingImage.src = "assets/buddy_standing_still_eye_closed.png";
    this.jumpingImage.onerror = () => {
      if (import.meta.env.DEV) console.error('Failed to load buddy_standing_still_eye_closed.png');
    };

    const buddyRunImage1 = new Image();
    buddyRunImage1.src = "assets/buddy_run1.png";
    buddyRunImage1.onerror = () => {
      if (import.meta.env.DEV) console.error('Failed to load buddy_run1.png');
    };

    const buddyRunImage2 = new Image();
    buddyRunImage2.src = "assets/buddy_run2.png";
    buddyRunImage2.onerror = () => {
      if (import.meta.env.DEV) console.error('Failed to load buddy_run2.png');
    };
